...
<body class="body">
    <div id="wrapper">
        <div id="page" class="">
                                ...
                                <ul class="sub-menu">
                                    <li class="sub-menu-item">
                                        <a href="{{route('admin.category-add')}}" class="">
                                            <div class="text">Kategori Baru</div>
                                        </a>
                                    </li>
                                    <li class="sub-menu-item">
            ...
            <div class="section-content-right">event.preventDefault(); // Benar
                        ...
                        <div class="header-left">
                            ...
                            <form class="form-search flex-grow">
                                ...
                                <div class="box-content-search" id="box-content-search">
                                    <ul class="mb-24">
                                        <li class="mb-14">
                                            <div class="body-title">Produk terlaris</div>
                                        </li>
                                        <li class="mb-14">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end has-content"
                                        ...
                                        <li>
                                            <div class="message-item item-1">
                                                ...
                                                <div>
                                                    <div class="body-title-2">Diskon tersedia</div>
                                        ...
                                        <li>
                                            <div class="message-item item-2">
                                                ...
                                                <div>
                                                    <div class="body-title-2">Akun telah diverifikasi</div>
                                        ...
                                        <li>
                                            <div class="message-item item-3">
                                                ...
                                                <div>
                                                    <div class="body-title-2">Pesanan berhasil dikirim</div>
                                        ...
                                        <li>
                                            <div class="message-item item-4">
                                                ...
                                                <div>
                                                    <div class="body-title-2">Pesanan Tertunda: <span>ID 305830</span>
                                                    </div>
                                                    <div class="text-tiny">Ultricies at rhoncus at ullamcorper</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li><a href="#" class="tf-button w-full">lihat Semua</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <button class="btn btn-secondary dropdown-toggle" type="button"
                                        ...
                                        <span class="header-user wg-user">
                                            ...
                                            <span class="flex flex-column">
                                                <span class="body-title mb-2">Yogi Winarto</span>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end has-content"
                                        ...
                                        <li>
                                            <a href="#" class="user-item">
                                                ...
                                                <div class="body-title-2">Akun</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="user-item">
                                                ...
                                                <div class="body-title-2">Kotak Masuk</div>
                                        ...
                                        <li>
                                            <a href="#" class="user-item">
                                                ...
                                                <div class="body-title-2">Papan Tugas</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="user-item">
                                                ...
                                                <div class="body-title-2">Dukungan</div>
                                            </a>
                                        </li>
                                        <li>
                ...
                <div class="main-content">
                    ...
                    <div class="bottom-page">
                        <div class="body-text">Lumira</div>
                    </div>
                </div>
