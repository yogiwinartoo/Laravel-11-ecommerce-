...
<main class="pt-90">
        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
              <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Beranda</a>
            ...
            <div
              ...
              <a href="#" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                ...
                </svg><span class="menu-link menu-link_us-s">Sebelumnya</span></a>
              <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">selanjutnya</span><svg
          ...
          <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-primary btn-addtocart" data-aside="cartDrawer">Tambah ke Keranjang</button>
            </div>
          </form>
          @endif
          <div class="product-single__addtolinks">
            <a href="#" class="menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20"
                ...
                <use href="#icon_heart" />
              </svg><span>Tambahkan Wishlist</span></a>
              ...
              <details id="Details-share-template__main" class="m-1 xl:m-1.5" hidden="">
                ...
                <div id="Article-share-template__main"
                  ...
                  <div class="field grow mr-4">
                    <label class="field__label sr-only" for="url">Tautan</label>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore active" id="tab-description-tab" data-bs-toggle="tab"
              href="#tab-description" role="tab" aria-controls="tab-description" aria-selected="true">Deskripsi</a>
          </li>
          <li class="nav-item" role="presentation">
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab" href="#tab-reviews"
              role="tab" aria-controls="tab-reviews" aria-selected="false">Ulasan (2)</a>
          </li>
        </ul>
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="tab-additional-info" role="tabpanel" aria-labelledby="tab-additional-info-tab">
            <div class="product-single__addtional-info">
              <div class="item">
                <label class="h6">Berat</label>
                <span>1.25 kg</span>
              </div>
              <div class="item">
                <label class="h6">Dimensi</label>
                <span>90 x 60 x 90 cm</span>
              </div>
              <div class="item">
                <label class="h6">Ukuran</label>
                <span>XS, S, M, L, XL</span>
              </div>
              <div class="item">
                <label class="h6">Warna</label>
                <span>Hitam, Oren, Putih</span>
              </div>
              <div class="item">
                <label class="h6">Model</label>
                <span>Gaun model kemeja longgar dengan potongan kasar</span>
              </div>
            </div>
          </div>
          <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="tab-reviews-tab">
            <h2 class="product-single__reviews-title">Ulasan</h2>
            <div class="product-single__reviews-list">
              <div class="product-single__reviews-item">
                ...
                <div class="customer-review">
                  ...
                  <div class="review-date">Juni 22, 2025</div>
                  <div class="review-text">
                    <p>Di waktu luang, ketika kita memiliki kebebasan untuk memilih dan ketika tidak ada yang menghalangi kita untuk melakukan apa yang paling kita sukai, kita harus merangkul semua kesenangan…</p>
                  </div>
                </div>
              </div>
              <div class="product-single__reviews-item">
            ...
            <div class="product-single__review-form">
              <form name="customer-review-form">
                <h5>Jadilah yang pertama mengulas “Kaos Katun Message”</h5>
                ...
                <div class="form-label-fixed mb-4">
                  <label for="form-input-name" class="form-label">Nama *</label>
                  <input id="form-input-name" class="form-control form-control-md form-control_gray">
                </div>
                <div class="form-label-fixed mb-4">
                  <label for="form-input-email" class="form-label">Alamat Email *</label>
    ...
    <section class="products-carousel container">
      <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4">Terkait <strong>Produk</strong></h2>
