...
<main>
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Produk Terbaru</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Beragam Pakaian</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Pria</h2>
              <a href="#"
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Produk Terbaru</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Beragam Pakaian</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Wanita</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Belanja Sekarang</a>
            </div>
          </div>
          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Produk Terbaru</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Beragam Pakaian</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Anak-anak</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Belanja Sekarang</a>
            </div>
          </div>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Anda Mungkin Menyukai</h2>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Wanita<br />Atasan</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_2.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Wanita<br />Celana</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_3.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Wanita<br />Pakaian</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_4.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Pria<br />Jeans</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_5.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Pria<br />Baju</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_6.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Pria<br />Sepatu</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_7.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Wanita<br />Gaun</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_8.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="#" class="menu-link fw-medium">Anak<br />Atasan</a>
                </div>
              </div>
            </div><!-- /.swiper-wrapper -->
      ...
      <section class="hot-deals container">
        ...
        <div class="row">
          <div
            ...
            <a href="{{route('shop.index')}}" class="btn-link default-underline text-uppercase fw-medium mt-3">Lihat semua</a>
          </div>
                            ...
                            <div class="product-card__price d-flex">
                                <span class="money price text-secondary">
                                    @if ($sproduct->sale_price)
                                        <s>Rp{{ number_format($sproduct->regular_price, 0, ',', '.') }}</s> Rp{{ number_format($sproduct->sale_price, 0, ',', '.') }}
                                    @else
      ...
      <section class="products-grid container">
                    ...
                    <div class="product-card__price d-flex align-items-center">
                        <span class="money price text-secondary">
                            @if ($fproduct->sale_price)
                                <s>Rp{{ number_format($fproduct->regular_price, 0, ',', '.') }}</s> Rp{{ number_format($fproduct->sale_price, 0, ',', '.') }}
                            @else
        ...
        <div class="text-center mt-2">
          <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="#">Tampilkan Lebih Banyak</a>
        </div>
      </section>
    </div>
